...
<head>
    ...
    <link type="text/css" rel="stylesheet"
          href="${pageContext.request.contextPath }/static/js/validator/style/validator.css"></link>
    <script src="${pageContext.request.contextPath }/static/js/jquery.min.js" type="text/javascript"
            charset="UTF-8"></script>
    <script src="${pageContext.request.contextPath }/static/js/validator/formValidator.js" type="text/javascript"
            charset="UTF-8"></script>
    <script src="${pageContext.request.contextPath }/static/js/validator/formValidatorRegex.js" type="text/javascript"
            charset="UTF-8"></script>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.formValidator.initConfig({
                formid: "registerForm", onerror: function (msg) {
                }, onsuccess: function () {
                    return true;
                }
            });
            ...
            $("#loginName").formValidator({
                onshow: "请输入用户名",
                onfocus: "6-20位字母、数字、下划线组成", oncorrect: "该用户名可以注册"
            }).inputValidator({min: 6, max: 20, onerror: "用户名长度不满足要求"}).regexValidator({
                regexp: "username",
                datatype: "enum",
                onerror: "用户名格式不正确"
            })
                .ajaxValidator({
                    type: "post",
                    url: "${pageContext.request.contextPath }/login/checkLoginName",
                    data: {
                        "loginName": function () {
            ...
            $("#telnum").formValidator({
                ...
                onfocus: "输入的手机号必须合法",
                oncorrect: "该手机号可以注册"
            }).inputValidator({min: 11, max: 11, onerror: "手机号码必须是11位的哦"}).regexValidator({
                regexp: "mobile",
                datatype: "enum",
                onerror: "手机号格式不正确"
            })
                .ajaxValidator({
                    type: "post",
                    url: "${pageContext.request.contextPath }/login/checkPhone",
                    data: {
                        "telnum": function () {
                            return $("#telnum").val();
                        }
            ...
            $("#email").formValidator({
                ...
                .ajaxValidator({
                    type: "post",
                    url: "${pageContext.request.contextPath }/login/checkEmail",
                    data: {
                        "email": function () {
                            return $("#email").val();
                        }
            ...
            $("#companyname").formValidator({
                ...
                onfocus: "请输入企业名称",
                oncorrect: "该企业名可以注册"
            }).inputValidator({min: 6, onerror: "企业名称长度不满足要求"})
                .ajaxValidator({
                    type: "post",
                    url: "${pageContext.request.contextPath }/login/checkCompanyname",
                    data: {
            ...
            //qq
            $("#qq").formValidator({onshow: "请输入qq号码", onfocus: "请输入qq号码", oncorrect: "qq号码有效"}).inputValidator({
                min: 6,
                onerror: "qq号码长度不满足要求"
            }).regexValidator({regexp: "qq", datatype: "enum", onerror: "qq号码格式不正确"});
            ...
            $("#username").formValidator({
                ...
                onfocus: "请输入汽配商联系人",
                oncorrect: "格式正确"
            }).inputValidator({min: 2, onerror: "不能少于2个字符"});
        });
    ...
    <script type="text/javascript">
        ...
        function getProvince() {
            $.ajax({
                type: 'post',
                url: "${pageContext.request.contextPath }/login/getCity",
                dataType: 'json',
        ...
        function getCity() {
            ...
            if (object.val() != 0) {
                $.ajax({
                    type: 'post',
                    url: "${pageContext.request.contextPath }/login/getCity?parentId=" + object.val(),
                    dataType: 'json',
                    success: function (result) {
                        $.each(result, function (entryIndex, entry) {
                            var html = "<option value='" + entry["id"] + "'>"
...
<div class="wid top1"><img src="${pageContext.request.contextPath }/static/images/logo1.jpg"/></div>
<div class="zhuce">
    <div class="wid">
        <form method="post" id="registerForm" action="${pageContext.request.contextPath }/login/register">
            <div class="zhuce_wid">
                ...
                <div class="f-cb zhuce_tt">
                    <span>固定电话:</span>
                    <input type="text" placeholder="区号1" class="mar6" style="width:50px;" name="zone1" id="zone1"><input
                        type="text" placeholder="座机号1" class="mar6" style="width:150px;" name="tel1" id="tel1"> <input
                        type="text" placeholder="区号2" class="mar6" style="width:50px;" name="zone2" id="zone2"><input
                        type="text" placeholder="座机号2" class="mar6" style="width:150px;" name="tel2" id="tel2">
                </div>
                ...
                <div class="f-cb zhuce_tt zhuce_bg">
                    ...
                    <ul>
                        <li style="width:880px">
                            <button class="tt_btn" onclick="duozhong(this);" type="button">多种品牌</button>
                        ...
                        <li style="width:880px">
                            <button class="tt_btn" onclick="danyi(this);" type="button">单一品牌</button>
                        ...
                        <li style="width:880px">
                            <button class="tt_btn" onclick="zhuanlei(this);" type="button">单项配件</button>
                        ...
                        <li style="width:880px">
                            <button class="tt_btn" onclick="primes(this);" type="button">精品专卖</button>
                ...
                <div class="f-mt-25 zhuce_tt">
                    ...
                    <strong>点击“立即注册”，即表示您同意修配连&nbsp;<a href="javascript:;" onclick="getProtocol()">用户协议</a>&nbsp;和&nbsp;<a
...
<div class="footer">Copyright © 2019-2024 www.xingyu.com All Rights Reserved. 星宇 版权所有</div>
<script type="text/javascript">
    ...
    function getProtocol() {
        ...
        request.open('GET', '${pageContext.request.contextPath }/loginAction.do?method=register', true);
        //
